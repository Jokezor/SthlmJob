...
$commandString = escapeshellarg('s3cmd put /var/www/html/uploads/') . escapeshellarg($keyname) . escapeshellarg(' s3://sthlmjobcvinput1/') . escapeshellarg($email) . escapeshellarg('/CV.') . escapeshellarg($ext);
